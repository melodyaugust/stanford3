...
# Experiment 1: takes around 1h on the provided VM with a Tesla V100 GPU
python protonet.py --num_support 5 $ARG_DEVICE $ARG_BATCH_SIZE $ARG_COMPILE $ARG_BACKEND

# Experiment 2: takes around 1h on the provided VM with a Tesla V100 GPU
python protonet.py $ARG_DEVICE $ARG_BATCH_SIZE $ARG_COMPILE $ARG_BACKEND

# Maml experiments

# Experiment 1: takes around 2h on the provided VM with a Tesla V100 GPU
python maml.py $ARG_DEVICE $ARG_BATCH_SIZE

# Experiment 2: takes around 2h on the provided VM with a Tesla V100 GPU
python maml.py --inner_lr 0.04 $ARG_DEVICE $ARG_BATCH_SIZE

# Experiment 3: takes around 3h on the provided VM with a Tesla V100 GPU
python maml.py --inner_lr 0.04 --num_inner_steps 5 $ARG_DEVICE $ARG_BATCH_SIZE

# Experiment 4: takes around 2h on the provided VM with a Tesla V100 GPU
